/* LexiGenTokenManager.java */
/* Generated By:JavaCC: Do not edit this line. LexiGenTokenManager.java */
import java.io.*;
import java.util.*;

/** Token Manager. */
@SuppressWarnings("unused")public class LexiGenTokenManager implements LexiGenConstants {
    public Token getNextTokenB() {
        ...
        matchedToken = jjFillToken();
        matchedToken.kind = LexiGenTokenManager.EOF;
        return matchedToken;
    }
...
private final int jjStopStringLiteralDfa_0(int pos, long active0){
   switch (pos)
   {
      case 0:
         ...
         return -1;
      case 1:
         if ((active0 & 0x221000L) != 0L)
            return 19;
         if ((active0 & 0x7ddefe0L) != 0L)
         {
            jjmatchedKind = 48;
            jjmatchedPos = 1;
            return 19;
         ...
         return -1;
      case 2:
         if ((active0 & 0x8128c0L) != 0L)
            return 19;
         if ((active0 & 0x75cc720L) != 0L)
         {
            jjmatchedKind = 48;
            jjmatchedPos = 2;
            return 19;
...
private int jjMoveStringLiteralDfa0_0(){
   switch(curChar)
   {
      ...
      case 101:
         return jjMoveStringLiteralDfa1_0(0xc0040L);
      case 102:
         return jjMoveStringLiteralDfa1_0(0x2010100L);
      case 103:
...
private int jjMoveStringLiteralDfa1_0(long active0){
   ...
   switch(curChar)
   {
      ...
      case 108:
         return jjMoveStringLiteralDfa2_0(active0, 0xc0100L);
      case 110:
         return jjMoveStringLiteralDfa2_0(active0, 0x8e0L);
      case 111:
         if ((active0 & 0x200000L) != 0L)
            return jjStartNfaWithStates_0(1, 21, 19);
         return jjMoveStringLiteralDfa2_0(active0, 0x4012200L);
      case 114:
...
private int jjMoveStringLiteralDfa2_0(long old0, long active0){
   ...
   switch(curChar)
   {
      ...
      case 105:
         return jjMoveStringLiteralDfa3_0(active0, 0x4104020L);
      case 108:
...
static final int[] jjnextStates = {
   11, 12, 14, 15, 16, 5, 4, 6, 1, 2, 
};

/** Token literal values. */
public static final String[] jjstrLiteralImages = {
"", null, null, null, null, "\151\156\151\164", "\145\156\144", 
"\151\156\164", "\146\154\157\141\164", "\142\157\157\154", "\163\164\162\151\156\147", 
"\141\156\144", "\157\162", "\156\157\164", "\160\162\151\156\164", "\162\145\141\144", 
"\146\157\162", "\151\146", "\145\154\163\145", "\145\154\163\145\151\146", 
"\167\150\151\154\145", "\144\157", "\144\145\146\151\156\145", "\147\145\164", "\164\162\165\145", 
"\146\141\154\163\145", "\166\157\151\144", "\53", "\55", "\52", "\57", "\75\75", "\41\75", "\76", 
"\74", "\76\75", "\74\75", "\75", "\73", "\173", "\175", "\50", "\51", "\133", 
"\135", "\54", "\56", null, null, null, null, null, null, null, };
...
private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    /** Constructor. */
    public LexiGenTokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public LexiGenTokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
