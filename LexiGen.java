/* LexiGen.java */
/* Generated By:JavaCC: Do not edit this line. LexiGen.java */
import java.io.*;
import java.util.*;

public class LexiGen implements LexiGenConstants {
    private static File codigoFuente;
    private static Environment environment = new Environment();  // Entorno para manejo de ámbitos
    private static GeneradorObj trans = new GeneradorObj("C:/LexiGen/CodigoObj.cpp");
    ...
    public static void main(String[] args) {
        ...
        try {
            LexiGenTokenManager lexicManager = new LexiGenTokenManager(new SimpleCharStream(new InputStreamReader(new FileInputStream(codigoFuente), "UTF-8")));
            LexiGen parser = new LexiGen(lexicManager);
            String command = "cmd /c start C:/LexiGen/Ensamble.bat";
...
trans.EscribirCod("// Inicio del programa en C++\u005cn");
        trans.EscribirCod(cpp);
        trans.EscribirCod("\u005cn// Fin del programa en C++\u005cn");
        trans.EscribirCod("return 0;\u005cn}");
  }
...
cpp += "cin >> " + var.image + ";\u005cn"; // Traducción directa para la entrada estándar de C++
...
if (environment.isDeclaredLocally(var.image)) {
            ...
            if (expr != null && !isTypeCompatible(tipoEsperado, expr)) {
                ...
                cpp += declCode + ";\u005cn";  // Correctamente añadir la declaración al código C++
            }
        }
  }
...
if (!environment.isDeclared(var.image)) {
            ...
            cpp += var.image + " = " + expr + ";\u005cn";  // Asumiendo que el error se maneja en otro lado
        } else {
            // Asumiendo que se verifica el tipo y otros errores semánticos antes de este punto
            cpp += var.image + " = " + expr + ";\u005cn";
        }
  }
...
nombreFuncion = token;
    jj_consume_token(PAREN_IZQ);
    jj_consume_token(PAREN_DER);
cpp += tipoRetorno.image + " " + nombreFuncion.image + "() {\u005cn";  // Comenzar la definición de la función en C++

    Bloque();
cpp += "}\u005cn";  // Cerrar la definición de la función en C++

  }

  /** Generated Token Manager. */
  public LexiGenTokenManager token_source;
  ...
  public LexiGen(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public LexiGen(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new LexiGenTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public LexiGen(java.io.Reader stream) {
  ...
  public LexiGen(LexiGenTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(LexiGenTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
